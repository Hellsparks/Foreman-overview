...
// GET /api/presets â€” list all presets
router.get('/', (req, res) => {
    const db = getDb();
...
// POST /api/presets â€” create a user preset
router.post('/', (req, res) => {
...
// PUT /api/presets/:id â€” edit a user preset
...
// DELETE /api/presets/:id â€” delete a user preset
