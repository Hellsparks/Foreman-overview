...
// GET /api/maintenance â€” all tasks, printers, intervals, history
router.get('/', (req, res) => {
  const db = getDb();
  try {
...
// POST /api/maintenance/tasks â€” create a task
...
// PUT /api/maintenance/intervals/:taskId/:printerId â€” set interval hours (0 = not tracked)
...
// POST /api/maintenance/done/:taskId/:printerId â€” mark task as done now
