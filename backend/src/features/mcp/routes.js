 ...
 *
 * GET  /api/mcp/status  â€” { running, pid, port, marathonUrl, endpoint }
 * POST /api/mcp/start   â€” body: { port?, marathonUrl? } â†’ start or no-op
 * POST /api/mcp/stop    â€” kill the process
 */
...
// In Docker mode the repo is mounted at /repo; locally __dirname=â€¦/backend/src/routes â†’ ../../.. = repo root
